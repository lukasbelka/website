...
export const SITE_DATA = {
    ...
    tagline: "I support reinsurers and primary carriers in turning fragmented, multi-entity insurance data into reliable data products, and work on Agentic AI starting with underwriting intake.",
    ...
    description: "Insurance and Reinsurance Professional with a strong focus on data, data analytics and AI innovation in the insurance and reinsurance industry.",
